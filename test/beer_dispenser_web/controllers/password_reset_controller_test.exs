defmodule BeerDispenserWeb.PasswordResetControllerTest do
  use BeerDispenserWeb.ConnCase

  import BeerDispenserWeb.AuthTestHelpers

  setup %{conn: conn} do
    conn = conn |> bypass_through(BeerDispenserWeb.Router, :browser) |> get("/")
